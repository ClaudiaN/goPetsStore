...
<div class="container"> 
   ...
   {!! Form::open(array('method'=>'POST','route' => ['producto.store'],'enctype'=>'multipart/form-data')) !!}
    <div class="row">
      <div class="col-sm-6">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Productos:</strong>
                <input type="hidden" id="creadoPor" name="creadoPor" value=" {{ Auth::user()->name }}">
                <select id="idProducto" name="idProducto" class="form-control" onChange="activarDescripcion()">
                    <option value="x"> Listado de productos </option>
                    <option value="y"> Nuevo producto </option>    
        ...
        <div class="col-xs-12 col-sm-12 col-md-12" id="divDescrip">
            <div class="form-group">
                <hidden name="estado" id="estado" value="Activo"/> 
                <strong>Descripción:</strong>
                 {!! Form::text('descripcion', null, array('placeholder' => 'Si el producto no esta en el listado anterior inidique la descripción','class' => 'form-control ', 'id'=>'descripcion')) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Color:</strong>
                    ...
                    <option value="<?= $color->idColor; ?>"> <?= $color->descriColor; ?> </option>    
                    <?php } ?>           
                    </select>
            </div>                   
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Talla:</strong>
                    ...
                    <option value="<?= $talla->idTalla; ?>" > <?= $talla->descriTalla; ?> </option>    
                    <?php } ?>           
                    </select>
            </div>                   
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Precio de venta:</strong>
                 {!! Form::text('precioVenta', null, array('placeholder' => 'Precio de Venta','class' => 'form-control','required'=>'required')) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Precio de Envio:</strong>
                 {!! Form::text('precioEnvio', null, array('placeholder' => 'Precio de Envio','class' => 'form-control','required'=>'required')) !!}
            </div>
        </div>
      </div>
      <div class="col-sm-6">
